...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 28409c5f-8cd8-44af-b320-f34d59febb1b
```

> `28409c5f-8cd8-44af-b320-f34d59febb1b` is the password of the certificate, you can change it to any password you want.
